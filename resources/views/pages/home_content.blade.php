...
<div class="col-sm-12">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#tshirt" data-toggle="tab">Kurti</a></li>
    <li><a href="#blazers" data-toggle="tab">Punjabi</a></li>
    <li><a href="#sunglass" data-toggle="tab">Katua</a></li>
    <li><a href="#kids" data-toggle="tab">Shal</a></li>
