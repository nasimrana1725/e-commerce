...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="manufacture" href="index.html"><span>Metro</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet"> Slider</span></a></li>
						<li><a href="{{URL::to('/order_list')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Order</span></a></li>
						<li><a href="{{URL::to('/sell_list')}}"><i class="icon-font"></i><span class="hidden-tablet"> Sell</span></a></li>
						<li><a href="{{URL::to('/profit')}}"><i class="icon-picture"></i><span class="hidden-tablet"> Profit</span></a></li>
	...
	<!-- start: JavaScript-->
	  ...
	  <script src="{{asset('backend/js/jquery.flot.resize.min.js')}}"></script>
		...
		<script type="text/JavaScript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.1/bootbox.min.js')}}"></script>
